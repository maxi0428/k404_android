...
class ViewPagerTestActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 바인딩 작업, 뷰 페이저2가 기본화면, 여기에 데이터 항목들이 주입됨.
...
//        datas.add(R.drawable.cat3)
    ...
    class MyPagerAdapter(val datas: MutableList<String>): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            //뷰에 데이터 출력
            //binding.itemPagerTextView2.setImageResource(datas[position])
            when(position % 4) {
                0 -> binding.itemPagerTextView2.setImageResource(R.drawable.cat)
                1 -> binding.itemPagerTextView2.setImageResource(R.drawable.cat2)
                2 -> binding.itemPagerTextView2.setImageResource(R.drawable.cat3)
                3 -> binding.itemPagerTextView2.setImageResource(R.drawable.cat4)
            }
//            when(position % 4){
//                0 -> binding.itemPagerTextView2.setBackgroundColor(Color.RED)
//                1 -> binding.itemPagerTextView2.setBackgroundColor(Color.BLUE)
//                2 -> binding.itemPagerTextView2.setBackgroundColor(Color.GREEN)
//                3 -> binding.itemPagerTextView2.()
//            }
        }
    }
}